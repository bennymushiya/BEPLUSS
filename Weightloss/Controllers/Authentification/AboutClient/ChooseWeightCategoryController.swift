////
////  ChooseWeightCategoryController.swift
////  Weightloss
////
...
class ChooseWeightCategoryController: UIViewController {
    ...
    private let ChooseCommunityLabel: AuthLabels = {
        let label = AuthLabels(title: "Pick The Your Community")
    ...
    private let descriptionLabel: AuthLabels = {
        let label = AuthLabels(title: "Choose a Community that relates to your current situation")
